...
public class NEATFlappyBird extends JPanel implements Runnable {
    ...
    public static void main(final String[] args) {
        for(int i = 0; i < 10; i++) {// Titties
            ...
            try {
                writer = new FileWriter("TanStats.txt", true);
...
//            catch(InterruptedException ex){}
                ...
                if(genNum == 25){
                    ...
                    writer.write("MaxFitness: " + maxFitness);
                    writer.flush();
                    frame.remove(neat);
                    bool = false;
                    genNum = 0;
    ...
    public void paint(final Graphics g_) {
        ...
        g2d.drawString("GENERATION " + generation, 15, 190);
        ...
        d = getBounds(g2d, g2d.getFont(),
                "FITNESS " + best.genome.fitness + "/" + maxFitness);
        g2d.drawString("FITNESS " + best.genome.fitness + "/" + maxFitness,
                561 - d.width, 190);
    }
